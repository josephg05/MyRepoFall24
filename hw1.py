...
# I used w3schools Python-Loop Lists, geeksforgeeks Python list count() method, geeksforgeeks python string find() method, and code from prevoius classes
...
def samecatdog(string):
   ...
   *** This can be simplfied using a Python string method ***
    ...
    # totalDog = 0
    # for i in range(len(string)):
    #     if string.find('cat') == True:
    #         totalCat += 1
    #     if string.find('dog') == True:
    #         totalDog += 1
